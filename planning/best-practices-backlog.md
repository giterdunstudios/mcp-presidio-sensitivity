...
| BP-029 | Re-add pre-Istio JWT auth enforcement gate | `deferred` | Security/Privacy Lead + Technical Implementation Lead | Phase 2 (Istio install) | Auth enforcement gap accepted as known until Istio is deployed (DEC-003). Local dev only — no production exposure. Re-evaluate trigger: Istio installation in Phase 2. Discovered 2026-03-27. |
