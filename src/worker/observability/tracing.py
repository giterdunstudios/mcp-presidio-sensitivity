"""
OpenTelemetry tracing configuration for the Presidio worker.
...
Security note:
  ...
  scan IDs, language codes, decision labels, severity bands, findings counts.
"""
...
def get_tracer(name: str = "presidio-worker") -> trace.Tracer:
